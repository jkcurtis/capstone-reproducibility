...
By looking at the means it appears that the metal group had more words per minute than the group with no music.
<!--
...
The results of the t-test show that the participants of the metal music group typed more words per minute than the participants of the no music group, t(62) = 2.33, p = .0230.
<!--
...
-->
Run an independent t-test with the alternative hypothesis
that the metal music group is faster than the no music group.
...
t.test(dat$wpm[dat$music=="none"],
       ...
       paired=TRUE)
```
Participants in the metal music group typed faster than the participants in the no music group, t(31) = -12.153, p < .05.